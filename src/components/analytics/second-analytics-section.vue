    ...
    <div class="container relative md:mt-24 my-16">
        <div class="grid md:grid-cols-2 grid-cols-1 items-center mt-10 gap-[30px]">
            <div class="relative flex-1 min-h-[500px]"> 
                <svg fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full h-full object-cover absolute inset-0" viewBox="0 0 1203 753">
                    <g clipPath="url(#path0)">
                        <path d="M0 52H1202V741C1202 747.627 1196.63 753 1190 753H12C5.37258 753 0 747.627 0 741V52Z" class="fill-[#E5E5E5] dark:fill-[#404040]"></path>
                        <path fillRule="evenodd" clipRule="evenodd" d="M0 12C0 5.37258 5.37258 0 12 0H1190C1196.63 0 1202 5.37258 1202 12V52H0L0 12Z" class="fill-[#E5E5E5] dark:fill-[#404040]"></path>
                        <path fillRule="evenodd" clipRule="evenodd" d="M1.06738 12C1.06738 5.92487 5.99225 1 12.0674 1H1189.93C1196.01 1 1200.93 5.92487 1200.93 12V51H1.06738V12Z" class="fill-white dark:fill-[#262626]"></path>
                        ...
                        <path d="M286 17C286 13.6863 288.686 11 292 11H946C949.314 11 952 13.6863 952 17V35C952 38.3137 949.314 41 946 41H292C288.686 41 286 38.3137 286 35V17Z" class="fill-[#E5E5E5] dark:fill-[#404040]"></path>
            ...
            <div class="lg:ms-8">
                <div class="grid grid-cols-1 gap-[20px]">
                    <div v-for="item in analytics" :key="item"
                        class="group flex items-center relative overflow-hidden p-2 rounded-md shadow dark:shadow-gray-800 bg-gray-50 dark:bg-slate-800 hover:bg-dropshiphub-primary-500 dark:hover:bg-dropshiphub-primary-500 duration-500">
                        <span class="text-dropshiphub-primary-500 group-hover:text-white text-7xl font-semibold duration-500">
                            <i :class="item.icon"></i>
                        </span>
    ...
    <div class="container relative md:mt-24 my-16">
        <div class="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
            <div class="relative order-1 md:order-2">
                <img src="../../assets/images/classic03.svg" class="rounded-lg shadow-md dark:shadow-gray-800" alt="">
                <!-- <div class="overflow-hidden absolute lg:size-[400px] size-[320px] bg-dropshiphub-primary-500/5 bottom-0 end-0 rotate-45 -z-1 rounded-3xl"></div> -->
            </div>
            <div class="lg:me-8 order-2 md:order-1">
                <h4 class="mb-4 text-2xl leading-normal font-medium"> {{ $t('getNotified.notification.title') }}</h4>
                <p class="text-slate-400"> {{ $t('getNotified.notification.description') }}</p>
                <ul class="list-none text-slate-400 mt-4">
                    <li v-for="(item, index) in $t('getNotified.notification.features')" :key="index"  class="mb-1 flex">
                        <i class="uil uil-check-circle text-dropshiphub-primary-500 text-xl me-2"></i> 
                        {{ item }}
                    </li>
                </ul>
                <div class="mt-4">
                    <router-link to="/page-aboutus"
                        class="relative inline-block font-semibold tracking-wide align-middle text-base text-center border-none after:content-[''] after:absolute after:h-px after:w-0 hover:after:w-full after:end-0 hover:after:end-auto after:bottom-0 after:start-0 after:duration-500 text-dropshiphub-primary-500 hover:text-dropshiphub-secondary-500 duration-500 ease-in-out">
                        {{ $t('getNotified.notification.cta') }}
      ...
      return [
        {
          ...
          title: this.$t('secondAnalytics.features.composableCommerce.title'),
          desc: this.$t('secondAnalytics.features.composableCommerce.description')
        },
        {
          icon: 'uil uil-tachometer-fast-alt',
          icon2: 'uil uil-tachometer-fast-alt',
          title: this.$t('secondAnalytics.features.dataMerging.title'),
          desc: this.$t('secondAnalytics.features.dataMerging.description')
        },
        {
          icon: 'uil uil-user-check',
          icon2: 'uil uil-user-check',
          title: this.$t('secondAnalytics.features.orderRouting.title'),
          desc: this.$t('secondAnalytics.features.orderRouting.description')
        }
      ]
    }
  }
