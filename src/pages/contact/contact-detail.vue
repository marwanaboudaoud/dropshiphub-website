                    ...
                    <div class="lg:w-11/12 bg-white dark:bg-slate-900 rounded-md shadow-lg dark:shadow-gray-800 overflow-hidden">
                        <div class="grid md:grid-cols-12 grid-cols-1 items-center">
                            ...
                            <div class="lg:col-span-5 md:col-span-6">
                                <div class="p-6">
                                    <h3 class="mb-6 text-2xl leading-normal font-medium">Let's talk about your portfolio
                                    </h3>
                                    <p class="text-slate-400">Start working with Tailwind CSS that can provide
                                    ...
                                    <div class="flex items-center mt-6">
                                        ...
                                        <div class="">
                                            ...
                                            <a href="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d39206.002432144705!2d-95.4973981212445!3d29.709510002925988!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8640c16de81f3ca5%3A0xf43e0b60ae539ac9!2sGerald+D.+Hines+Waterwall+Park!5e0!3m2!1sen!2sin!4v1566305861440!5m2!1sen!2sin"
                                                data-type="iframe"
                                                class="video-play-icon relative inline-block font-semibold tracking-wide align-middle ease-in-out text-base text-center border-none after:content-[''] after:absolute after:h-px after:w-0 hover:after:w-full after:end-0 hover:after:end-auto after:bottom-0 after:start-0 after:duration-500 text-indigo-600 hover:text-indigo-600 after:bg-indigo-600 duration-500 lightbox">
                                                View on Google map
                                            </a>
                                        </div>
                                    </div>
                                    <ul class="list-none mt-6 space-x-1">
                                        <li v-for="item in socials" :key="item" class="inline">
                                            <a href="" class="size-8 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center border border-gray-100 dark:border-gray-800 rounded-md hover:border-indigo-600 hover:text-white hover:bg-indigo-600">
                                            <i :data-feather="item" class="size-4"></i></a>
                                        </li>
                                    </ul>
                                </div>
                                <div
                                    class="flex justify-center text-center p-6 border-t border-gray-100 dark:border-gray-800">
                                    <p class="mb-0 text-slate-400">© {{ date }} Techwind. Design with 
